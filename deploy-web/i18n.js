...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      "hero.title":
        "Find deals, book bakers and beauty pros, and trade safely across Africa, Europe, and Asia.",
      "hero.regionHeadline":
      ...
      "accountPassport.honest":
        "Shoppers use email only at signup (no password). Service providers set a password — everything is stored with salted hashes on the server.",
      ...
      "accountPassport.passwordSeller": "Password for your provider account (8+ characters)",
      "accountPassport.step1": "Enter your details",
      "accountPassport.step2": "Welcome — you are signed in",
      "accountPassport.magicLinkCta": "Email me a sign-in link",
      "accountPassport.magicLinkSent": "Check your inbox for a sign-in link (valid about 30 minutes).",
      "accountPassport.magicLinkFail": "Could not send a link right now. Try again later or sign in with a password if you have one.",
      "accountPassport.magicSignedIn": "Signed in from your email link.",
      ...
      "accountPassport.loginLead":
        "Service providers: sign in with email and password. Shoppers: tap “Email me a sign-in link” if you shop without a password.",
      ...
      "accountPassport.errMissingFields":
        "Please add a display name (2+ letters), a valid email, and pick your country. Service providers also need an 8+ character password.",
      ...
      "accountPassport.createLeadFast":
        "Two steps: your details, then a short welcome. Shoppers do not set a password; service providers choose one here.",
  ...
  const FORCE_NATIVE_LINES = {
    sn: {
      ...
      "Beauty, hair, barber, and bakery booking": "Beauty, hair, barber, ne bakery booking",
    ...
    nd: {
      ...
      "Beauty, hair, barber, and bakery booking": "Beauty, hair, barber, le bakery booking",
  ...
  const EXTRA_KEYS = {
    en: {
      ...
      "booking.title": "Beauty, hair, barber, and bakery booking",
      "booking.lead":
        "Bakers, hairdressers, barbers, nail artists, and makeup pros can publish available slots and let clients book instantly without manual back-and-forth.",
