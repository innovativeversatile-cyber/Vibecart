  ...
  const STRINGS = {
    en: {
      ...
      "hero.subtitleExtended":
        "Discover offers from Poland and Europe, with routes to South Africa, Namibia, Kenya, Ethiopia, Zimbabwe, and other African markets. Trade both directions across Africa and Europe, plus Dubai and selected Asian markets. Pay with trusted payment systems available in your country and use reliable, secure delivery options. AI helps with discovery and risk signals, but final decisions and legal responsibilities remain with humans.",
      ...
      "hero.sig1": "VC Signal",
      "hero.sig2": "Route Aura",
      "hero.sig3": "Trust Pulse",
